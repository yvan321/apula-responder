...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  void initState() {
    super.initState();
    print("📧 Logged in (notifications): ${FirebaseAuth.instance.currentUser?.email}");
  }

  // Center Modal (Alert Dialog Style)
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text("🏠 Address: ${data["userAddress"] ?? "Not Provided"}"),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text("Location: ${data["alertLocation"] ?? "Unknown"}"),
                                      const SizedBox(height: 6),
